...
<%@ include file="navbar.jsp" %>  
 ...
 <div class="container">
    <form:form class="well form-horizontal" action="${contextPath}/employee/create" method="post"  id="contact_form" modelAttribute="emp">
	<fieldset>
	...
	<div class="form-group">
  		...
  		<div class="input-group">
  			...
  			<form:input  name="first_name" path="firstName" placeholder="First Name" class="form-control"  type="text"/>
    	</div>
  		</div>
	</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label" >Last Name</label> 
		    ...
		    <div class="input-group">
		  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		  <form:input name="last_name" placeholder="Last Name" path= "lastName" class="form-control"  type="text"/>
		    </div>
		  </div>
		</div>
		...
		<div class="form-group"> 
		  <label class="col-md-4 control-label">Role</label>
		    ...
		    <select id="role" name="roles" class="form-control selectpicker" >
		...
		<div class="form-group eng" style="display:none">  
		  <label class="col-md-4 control-label">Manager</label>
		    ...
		    <div class="input-group">
		        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
		    <select id="manager" name="manager" class="form-control selectpicker">
		...
		<div class="form-group eng" style="display:none"> 
		  <label class="col-md-4 control-label">Projects</label>
		    ...
		    <div class="input-group">
		        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
		    <select id="project" name="project" class="form-control selectpicker">
		...
		<div class="form-group">
		  ...
		  <form:input name="email" placeholder="E-Mail Address" path="email" class="form-control"  type="text"/>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">Password</label>  
		    ...
		    <div class="input-group">
		        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
		  <form:input name="password" placeholder="Password" path="password" class="form-control"  type="password"/>
		    </div>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <form:input name="contact_no" placeholder="(639)" path="phone" class="form-control" type="text"/>
		    </div>
		  </div>
		</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">Wage (Per hour)</label>  
		    ...
		    <div class="input-group">
		        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
		  <form:input name="wage" id="Wage" placeholder="50" path="wage" class="form-control" type="number" required="required"/>
		    </div>
		  </div>
		</div>
		...
		<div class="form-group">
		  <label class="col-md-4 control-label">Leave Count</label>  
		    ...
		    <div class="input-group">
		        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
		  <form:input name="Leave_Count" id="lCount" placeholder="10" path="leaveCount" class="form-control" type="number" required="required"/>
		    </div>
		  </div>
		</div>
